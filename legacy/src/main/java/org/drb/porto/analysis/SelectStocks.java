   ...
   private static class SimplePhase2Grade extends Grade
   {
      ...
      public void ComputeGrade(Quotes q, String strTicker, Date dStart, Date dEnd)
      {
         ...
         try
         {
            ...
            volatilityIndex = computeVolatilityIndex(q, dStart, dEnd, Quotes.HIGH);
            m_bOk = true;
         }
      ...
      private int computeVolatilityIndex(Quotes q, Date dStart, Date dEnd, int high)
      {
         return 0;
      }
