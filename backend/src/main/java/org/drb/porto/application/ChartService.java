...
import org.drb.porto.domain.chart.OHLCDataItem;
import org.drb.porto.domain.chart.OHLCDataset;
import org.drb.porto.domain.chart.XYDataset;
...
public class ChartService
{
   ...
   */
   ...
   public void OnNextStock() throws DataException
   {
      if (m_theStocks == null)
   ...
   public void OnPrevStock() throws DataException
   {
      if (m_theStocks == null)
         m_theStocks = new Stocks();
   ...
   private void SetLooseName(String strLooseName)
   {
   ...
   public OHLCDataset Plot() throws DataException
   {
      if (m_theStocks == null)
      {
      ...
      OHLCDataset theData = new OHLCDataset("Candlesticks", theItems);
      
      //JFreeChart jfc = ChartFactory.createCandlestickChart(q.GetName(), m_strLooseName, "Price", theData, false);
      //ArrangeGraph(q, theData);
      //AddMobileAverage(q, theData);
      //AddReferenceIndice(q, theData);
      q.Release();
      return theData;
   }
...
//      XYDataset aDataset = new XYDataset(daDates, daMAvg);
//      XYItemRenderer aRenderer = new XYLineAndShapeRenderer(true, false);
...
//   }
    ...
    */
//   private void ArrangeGraph(Quotes q, OHLCDataset jfc)
//   {
